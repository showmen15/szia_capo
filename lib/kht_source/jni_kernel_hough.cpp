...
jobject as_line_list(JNIEnv * env,lines_list_t lines){
    ...
    jclass line_cls = env->FindClass("pl/edu/agh/capo/hough/common/Line");
...
JNIEXPORT jobject JNICALL Java_pl_edu_agh_capo_hough_jni_JniKernelHough_kht
  (JNIEnv * env, jobject method, jbyteArray binary_image, jlong image_width, jlong image_height,
  jlong cluster_min_size, jdouble cluster_min_deviation, jdouble delta, jdouble kernel_min_height, jdouble n_sigmas) {
